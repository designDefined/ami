import styles from "../components/edit/Weave/DragArea/DragArea.module.scss";
import classNames from "classnames/bind";
import { IAtom, IPage } from "../types/old/base";
import { CSSProperties, useMemo } from "react";
import createStyle from "../functions/create/createStyle";
import imageSample, { imageSampleList } from "../public/assets/images/images";
import { onPressPlacedAtom } from "../components/edit/handlers/weaveEventHandler";
